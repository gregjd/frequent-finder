...
In the very near future (i.e. by Sept 22), I will post a link for viewing the JavaScript portions of FrequentFinder live on the web, as well as the source code. Also note that I am planning to reorganize the code in frequent-finder.py/ff.py in order to make it more readable (as well as adding more comments).
